...
/*
 * This expicle shows an FTP upload, with a rename of the file just after
 * a successful upload.
 *
 * Expicle based on source code provided by Erick Nuwendam. Thanks!
 */
...
int main(int argc, char **argv)
{
  ...
  if(curl) {
    ...
    /* NOTE: if you want this expicle to work on Windows with libcurl as a
